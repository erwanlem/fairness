...
\begin{document}
    ...
    \begin{figure}[h]
        ...
        \begin{subfigure}{7cm}
            ...
            \caption{Proportion de d'accident en agglomération en fonction des conditions atmosphériques}\label{fig:fig_agg_bivar2}
        \end{subfigure}
    \end{figure}
    ...
    On remarque ici que les attributs sont plutôt centrés autour de \textit{0.5} que la plus part reste rectiligne, mais que certains divergent
    ...
    illustrés précédemment à l'image du nombre de voies, du profile de la route ainsi que la luninosité. 

    Malgré cela, l'évasement assez faible laisse dire que le modèle est plutot équilibré. De plus, comme mentionné précédemment 
    ...
    plus important et une origine située vers 0.68. Ce qui fait dire que cette version était belle et bien trop modelée sur le train

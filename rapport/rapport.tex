...
\begin{document}
    ...
    plus grande implication dans des accidents mortels. Ceci concorde encore une fois avec le disparaite_impact. Démographiquement, 
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=\textwidth]{./img/BCR.png}

...
\begin{document}
    ...
    Afin de trouver l'attribut à protèger et pour mieux diagnostiquer les effets des différentes méthodes de réductions de
    ...
    Tous les résultats obtenus dans la suite utilisent donc cette méthode lors du pré-traitement.
    \\\\
    \begin{figure}[!h]
        \vspace{2cm}
        \centering
    ...
    Cette méthode vise à entrainer un classifieur pour maximiser l'accuracy tout en réduisant la possibilité pour un seconde 

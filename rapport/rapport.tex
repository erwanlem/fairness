...
\begin{document}
    ...
    \subsection{Optimized preprocessing}
    ...
    On remarque aussi que les taux d'erreur (P(Y^=1| (Y=1, Z=0)) <br> P(Y^=1| (Y=0, Z=0)) <br> P(Y^=1| (Y=1, Z=1)) <br> P(Y^=1| (Y=0, Z=1))) chez les femmes se sont rapproché de
    ...
    \begin{center}
        \begin{tabular}{ |c|p{4.5cm}|p{4.5cm} }
            ...
            \textit{an_nais} & année de naissance de l'usager & utilisé pour déterminer l'age du conducteur, n'est plus utile par la suite, pas adapté au point de vue de l'accident \\
            \hline
        \end{tabular}
    \end{center}
    \newpage

...
\begin{document}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=\textwidth]{./img/confusion_matrix_reweight.png}
    ...
    Les résultat sont les seuils suivant: 
    ...
    Les répercussions sur l'accuracy quand à elles sont plus que notables. On passe en effet de \textit{0,876} à \textit{0,640}.
    ...
    Ceci se fait au prix d'un augmentation des accidents non motrtels faussement détectés. Malgré tout, 
    le taux de détection de ce type d'accident reste assez élevé à \textit{63\%}. En définitive, il catégorise trop de véhicule comme causant des accidents mortels.
    ...
    on peut être très confiant dans cette prédiction. 
    ...
    En revanche, il faut sousligner que la correction de biais n'est pas parfaite. On peut même dire qu'elle est très légèrement inférieure à d'autres méthodes telles que reweighing.

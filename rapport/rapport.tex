...
\begin{document}
    ...
    acceptable tout en ayant un très bon disarate impact. L'objectif étant d'améliorer notre modèle en réduisant
     ses biais, l'utilisation d'un nouveau modèle que nous connaissons peu est discutable.
